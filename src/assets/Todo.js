...
const Todo = ({ Data, Add, Delate }) => {
  const [text, settext] = useState("");
  const changing = (e) => settext(e.target.value);
  console.log(text);
      ...
      <article className="leaderboard">
        <header>
          ...
          <h1 className="leaderboard__title">
            <span className="leaderboard__title--top">ToDo List</span>
            <input
              type="text "
              className="leaderboard__title--bottom"
              onChange={changing}
            />
            <button
              className="leaderboard__title--bottom"
        ...
        <main className="leaderboard__profiles">
          {Data.map((ele) => (
            <article className="leaderboard__profile">
              <span className="leaderboard__name">{ele.name}</span>
              <button
